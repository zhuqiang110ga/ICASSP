...
def get_args():
    ...
    parser.add_argument("--dataset_dir", type=str, default='/Users/zhuqiang/Desktop/confidence/paper/icassp/data',
                        help='dataset directory'),
    parser.add_argument('--patch_size', type=int, default=256),
    parser.add_argument("--sub_set", type=str, default='sig17_training_crop128_stride64_aug',
                        help='dataset directory')
...
def main():
    ...
    # model architectures
    model = AHDR(nChannel=6,nFeat=60)
